 ...
 * @copyright 2017 Mariusz Boloz (https://mb2moodle.com)
...
if (!class_exists('admin_setting_configmb2color'))
{
	...
	class admin_setting_configmb2color extends admin_setting 
	{
		...
		public function output_html($data, $query='') 
		{
			...
			//$PAGE->requires->js(theme_mb2nl_theme_dir() . '/mb2nl2/assets/spectrum/spectrum.js');
			//$PAGE->requires->js(theme_mb2nl_theme_dir() . '/mb2nl2/assets/spectrum/spectrum_custom.js');	
