 ...
 *
 */
function theme_mb2nl_get_section_activities( $sectionid = 0, $label = false, $onlyvisible = false, $onlyuservisible = true )
{
 ...
 *
 */
function theme_mb2nl_section_module_list( $sectionid, $link = false, $active = false, $visible = false, $uservisible = true )
{
	global $PAGE;
	$output = '';
	$modules = theme_mb2nl_get_section_activities( $sectionid, true, $visible, $uservisible );

	if ( ! count( theme_mb2nl_get_section_activities( $sectionid, false, $visible, $uservisible ) ) )
	{
		return;
	}
...
function theme_mb2nl_course_sections_accordion()
{
	...
	{
		$modules =  theme_mb2nl_section_module_list( $section['id'], false, false, true, false );
