 ...
 *
 * @package   theme_mb2nl
 * @copyright 2017 - 2022 Mariusz Boloz (https://mb2moodle.com)
...
?>
<div class="course-header<?php echo $imgcls; ?>"<?php echo $herostyle; ?>>
	<div class="inner">
					...
					<div class="col-md-7">
						<div class="course-info1 dark">
							...
							<div class="course-meta1">
								...
								<?php endif; ?>
								<?php if ( $courserating ) : ?>
									<a href="#course-ratings" class="link-target">
						...
						<div class="course-info2">
							<div class="course-info2-inner">
								...
								<div class="fake-block block-enrol">
									<?php if ( $coursedate == 1 ) : ?>
										<div class="course-date"><?php echo theme_mb2nl_course_startdate(); ?></div>
									<?php elseif ( $coursedate == 2 && $updatedate ) : ?>
										<div class="course-date"><?php echo $updatedate; ?></div>
									<?php endif; ?>
									<?php $enrlstring = theme_mb2nl_get_sudents_count() ? get_string( 'alreadyenrolled', 'theme_mb2nl', array('students' => theme_mb2nl_get_sudents_count() ) ) : get_string( 'nobodyenrolled', 'theme_mb2nl' ); ?>
									<div class="enrol-text"><?php echo $enrlstring; ?></div>
									<a href="#page-content" class="btn btn-lg btn-primary course-enrolbtn sidebar-btn btn-full fwmedium"><?php echo $enrolbtntext; ?></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-md-9 enrol-contentcol">
				...
				<div class="details-section aboutcourse">
					...
					<div class="details-content<?php echo $settings->showmorebtn ? ' toggle-content' : ''; ?>">
						<div class="content-inner"><?php echo theme_mb2nl_get_mb2course_description(); ?></div>
				...
				<?php if ( $settings->skills ) : ?>
					<div class="details-section skills">
						...
						<div class="details-content">
							<div class="content-inner"><?php echo theme_mb2nl_static_content( $settings->skills ); ?></div>
						</div>
					</div>
				<?php endif; ?>
